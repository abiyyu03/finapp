...
class StoreJournalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // At least two lines, same as the posting-time rule (spec §12) —
            // a one-line journal isn't a meaningful draft either. Whether
            // debit = credit is NOT checked here: that's JournalPostingService's
            // job at POST time (STEP 6), not draft creation.
